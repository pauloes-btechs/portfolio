...
export const roles = [
  ...
  },
  {
    ...
    lede:
      "Nine years owning the university's technology estate end to end, from diagramming infrastructure inefficiencies that became a $2.8M modernization program to directing the migration to Microsoft Azure with secure hybrid connectivity and redundant failover, while running tenant-wide security and compliance across Microsoft 365 and passing every annual third-party audit.",
    responsibilities: [
    ...
    vendorsSub:
      "Vendor and partner relations managed across nine years of operations — procurement, managed services, consulting, and audit engagements, twenty relationships in all. A separate, broader surface than the three-vendor $2.8M program above.",
    vendors: [
    ...
    extraPanels: [
      {
        ...
        sub: "Detection, prevention, and remediation across the tenant, 2014–2023. Operated under the product names of the time; listed with their current Microsoft names.",
        bullets: [
