...
export const roles = [
  {
    ...
    location: "New York, NY",
    context:
      "MIT-backed New York charitable nonprofit building resilient, self-sovereign digital and financial infrastructure and delivering security- and privacy-focused, equitable AI/ML education.",
    card:
    ...
    lede:
      "BTechs is an MIT-backed New York charitable nonprofit delivering public-interest technology: resilient, self-sovereign digital and financial infrastructure for individuals, community organizations, and nonprofits, and security- and privacy-focused, equitable AI/ML education.",
    responsibilities: [
      ...
      "Lead the map's Global Mapping committee — PhD researchers and professors spanning computer science, mathematics, environmental science, law, government banking, philosophy, and electrical engineering — running customer interviews that define product features, attestation processes, and product requirements; the research database spans 29 institutions and 25 researchers, growing 200% quarter over quarter.",
      "Architect and operate the full production stack: React and TypeScript on a PostgreSQL/Supabase database, Vercel hosting and deployments, and GitHub-based source control and CI/CD, from local development through production.",
      ...
      "Built a strategic developer partnership with Btrust, the Bitcoin trust that manages 500 BTC, working with developers on the ground in Abuja, Nigeria, and trading trainings for developers in Bitcoin and AI/ML.",
    ...
    links: [
      ...
      { label: "Btrust — developer partnership", href: "https://www.btrust.tech/" },
    ],
  },
  {
    ...
    responsibilities: [
      "Worked backwards from small businesses priced out of card rails: designed and shipped a Bitcoinized inventory and settlement product on BTCPayServer that cut transaction fees by more than 90%, improving liquidity and bringing modern asset management within reach.",
      ...
      "Built a web platform for vessel tracking on open AIS data, integrating the AISHub and MarineTraffic APIs to monitor shipping in and out of the Red Sea across the Bab el-Mandeb Strait, the Gulf of Aden, and the Suez Canal, groundwork for introducing tokenization of real-world assets.",
      ...
      "Raised the Hub's founding capital — the three-year, $300K #startsmall grant from Jack Dorsey — and represented the Hub as a public speaker, including the recorded talk Empowering Through Education: Bitcoin's Role in Awareness and Adoption.",
    ...
    links: [
      ...
      { label: "Talk — Empowering Through Education: Bitcoin's Role in Awareness and Adoption", href: "https://www.youtube.com/watch?v=NubSrCXgmdk&t=1280s" },
    ],
  },
  {
    slug: "bloomberg",
    ...
    responsibilities: [
      ...
      "Shipped the Salesforce Marketing Cloud and SalesWings integration across the Law, Tax, and Government verticals, aligning sales and marketing on CRM-connected lead scoring by urgency and interest and reviving cold leads, lifting sales conversion rates 17% YoY and email CTR 25%.",
      "Led integration and onboarding of Salesforce Marketing Cloud, SalesWings, Webflow, and Asana through legal, procurement, and security review; Webflow campaign landing pages with twice-weekly social posting had Bloomberg Law generating leads 2.5x faster year over year.",
      "Treated compliance as a product requirement, not a review at the end: owned architecture, UX optimization, accessibility, privacy and policy, and technical SEO across the estate, sustaining a 100% pass rate across six GDPR/CCPA audits.",
      ...
      "Led Scrum ceremonies end to end, sprint planning, estimation and backlog refinement, daily standups, and retrospectives, and owned product documentation in Confluence alongside Google Docs, Sheets, and Slides.",
      "Prioritized the backlog and sprints against OKRs, and reported progress through monthly and quarterly business reviews with executives and keep-informed stakeholders: presentations and reports covering what shipped, what is in flight, and what comes next.",
      "Gated what entered the backlog and what got built based on ROI: sizing engineering and design costs against expected return before work was committed, and prioritizing work that cut tech debt and engineering spend alongside the customer needs carrying the highest return.",
      "Led Bloomberg CORE, a shared parent theme that grew out of the Bloomberg Law redesign: its best elements, mega menus, carousels, and cards, became a component library for every future web build, cutting production and deployment time and engineering cost of new builds by 50%, with updates and patches applied once and inherited identically by every site on the theme.",
      "Ran planning and architecture sessions on whiteboards and Miro to visualize roadmaps, system designs, and next steps, and managed delivery in Jira with engineers and designers: epics, stories, tasks, and bugs, with labels and components giving every project visibility in progress reports.",
      "Built RACI matrices during project planning to assign roles and responsibilities across engineering, design, marketing, legal, and executive stakeholders: one accountable owner per deliverable, consulted parties engaged before decisions were made, and informed groups tied to the right reporting cadence, eliminating ownership ambiguity and duplicated work across distributed teams.",
    ...
    skills: [
      "Enterprise platform ownership", "Roadmap strategy", "Agile at scale", "OKR-driven prioritization", "ROI analysis", "Design systems", "Scrum ceremonies", "RACI matrices", "Jira & Confluence", "Miro", "Privacy-by-design",
    ...
    certifications: [
      {
        ...
        image: "/certs/bmc.png",
        short: "Bloomberg's core financial markets credential, completed across eight Terminal-based modules.",
        issued: "December 27, 2021",
        url: "https://portal.bloombergforeducation.com/certificates/5mRvGkw64easRkvLjj41ndXQ",
        desc: "Bloomberg's core financial markets credential, built around 150+ Terminal functions and completed across eight modules: Economic Indicators, Currencies, Fixed Income, Equities, Terminal Basics, Commodities, Equity Options, and Portfolio Management.",
      },
      {
        name: "Bloomberg ESG Certificate",
        image: "/certs/esg.png",
        short: "ESG investment strategy and regulator-ready sustainability reporting, completed across seven modules.",
        issued: "July 17, 2023",
        url: "https://portal.bloombergforeducation.com/certificates/fgVZyPdcG98KCi63Y77RTGy3",
        desc: "ESG investment strategy and regulator-ready sustainability reporting, completed across seven modules: Introduction to ESG and Sustainable Finance, Researching and Adopting ESG, Negative and Positive Screening, ESG Integration for Fixed Income and for Equities, Corporate Governance and Shareholder Activism, and Reporting Sustainability Activities.",
      },
    ],
    links: [],
  },
  {
    ...
    kind: "enterprise",
    dates: "Mar 2014 – Jun 2022 · part-time consultant to Jul 2023",
    location: "Seattle, WA",
    secondPosition: {
      title: "Systems Engineering Consultant (part-time)",
      dates: "Jun 2022 – Jul 2023",
      desc: "Retained through the transition to Bloomberg to hand off the identity and infrastructure estate: knowledge transfer, access transitions, and escalation support for the successor team.",
    },
    context: "Eight years owning enterprise infrastructure and its product roadmap end to end.",
    card:
    ...
    lede:
      "Eight years owning the university's technology estate end to end, from diagramming infrastructure inefficiencies that became a $2.8M modernization program to directing the migration to Microsoft Azure with secure hybrid connectivity and redundant failover, while running tenant-wide security and compliance across Microsoft 365 and passing every annual third-party audit.",
    responsibilities: [
      "Diagrammed the infrastructure until the inefficiencies had nowhere to hide, then built the business case that became a one-year $2.8M program coordinating three vendors, five teams, and ten network products, the anchor of a two-year network infrastructure upgrade delivered through the first U.S.–China tariff war's hardware delays and cost escalations.",
      ...
      "Owned identity and access management for Azure resources and resource groups through Azure RBAC, scoping every role assignment to the least privilege possible.",
      "Built and ran the Azure network layer: virtual networks, VPN gateways, connections, and peerings, network security groups with inbound and outbound firewall rules, subnets, and DNS zones providing tertiary DNS redundancy.",
      "Deployed Azure Virtual Desktop (formerly Windows Virtual Desktop) workspaces for secure access to applications and resources, and gated server resources behind Just-in-Time access.",
      ...
      "Deployed a collaboration platform on Azure DevOps with Terraform and PowerShell-scripted automation to improve repeatability and scalability, cutting time to deploy per infrastructure project by 80% — from 16 hours to just over 3.",
      "Cut annual datacenter and maintenance spend in half — $250K to $125K — by consolidating physical servers onto VMware vSphere/ESXi virtual machines with Nimble NAS/SAN storage, shrinking the footprint from seven full racks to two, and relocating colocation from a downtown datacenter to Sabey's facility 15 miles outside the city for cheaper monthly hosting.",
      ...
      "Served on the university's security committee responsible for change management and the identity lifecycle: onboarding and offboarding users, and governing security groups whose membership auto-provisioned access to applications, file shares, and resources across the Microsoft environment.",
      "Ran hybrid identity across Entra ID, Office 365, and on-premises Active Directory, keeping directories synchronized across every domain controller, local and cloud, through Microsoft Entra Connect (then Azure AD Connect).",
      "Led vendor communications to stand up SAML single sign-on in Entra ID for third-party applications such as Zoom, Blackboard, and Brightspace: exchanging federation metadata and token-signing certificates, configuring sign-on and reply URLs and entity IDs, mapping identity claims such as name and email, and auto-provisioning users against available licenses through SCIM.",
      "Managed the Windows Server and SQL Server estates from Server 2012 through Server 2022, migrating and integrating workloads with Azure through Azure Migrate and System Center, and moving SQL services from on premises to the cloud with backups and restores.",
      "Ran SQL Server maintenance across full, differential, and transaction log backups, and configured networking and security access for instances and databases on least privilege, using group Managed Service Accounts and passwordless authentication.",
    ...
    vendorsSub:
      "Vendor and partner relations managed across eight years of operations — procurement, managed services, consulting, and audit engagements, twenty relationships in all. A separate, broader surface than the three-vendor $2.8M program above.",
    vendors: [
      ...
      { name: "GFI LanGuard" },
      { name: "DocImage" },
      { name: "Iron Mountain", logo: "/logos/vendors/ironmountain.png" },
      { name: "Zoom", logo: "/logos/vendors/zoom.png" },
      { name: "Blackboard", logo: "/logos/vendors/blackboard.png" },
      { name: "D2L Brightspace", logo: "/logos/vendors/brightspace.png" },
      { name: "Virtru", logo: "/logos/vendors/virtru.png" },
      ...
      { name: "Sabey", logo: "/logos/vendors/sabey.png" },
    ...
    skills: [
      ...
      "Azure DevOps & CI/CD", "PowerShell automation", "Identity & access management", "Azure RBAC & networking", "Azure Virtual Desktop",
      ...
      "Defender for Office 365", "Microsoft Sentinel", "Purview DLP", "Conditional Access", "Incident response & remediation", "SAML SSO & SCIM provisioning", "SQL Server administration",
      "Terraform", "VMware vSphere & ESXi", "Nimble NAS/SAN storage",
    ],
    extraPanels: [
      {
        heading: "Microsoft 365 Security & Compliance Operations",
        sub: "Detection, prevention, and remediation across the tenant, 2014–2022. Operated under the product names of the time; listed with their current Microsoft names.",
        bullets: [
          "Ran email threat protection across the tenant through Exchange Online Protection and Microsoft Defender for Office 365 (then Office 365 ATP) — tuning spam and phishing filter policies and thresholds, managing quarantine and release, and using zero-hour auto purge to retract spam and phishing mail already delivered.",
          "Maintained tenant allow and block lists for sender domains and IP ranges, and blocked sign-ins by country and IP range through Entra Conditional Access named locations.",
          "Wrote Microsoft Purview DLP policies (then Office 365 DLP) on sensitive-information types such as Social Security numbers, credit card numbers, dates of birth, and other PII, auto-encrypting outbound email containing them, and enforced tenant-wide compliance policies.",
          "Built anomaly detection and automated remediation in Microsoft Sentinel (then Azure Sentinel) and Entra ID Protection — alerting on unusual-IP and unusual-location sign-ins and auto-blocking risky accounts.",
          "Ran compromised-account investigation and response from the Microsoft Defender portal (then the Office 365 Security & Compliance Center): auditing sign-in activity, inbox rules, and user risk state on suspect accounts, confirming compromise in Entra ID Protection, remediating with forced password resets and revoked sign-in sessions to log out every device, and containing threats through quarantine policies, litigation holds on mailboxes under investigation, and automated investigation and response (AIR) playbooks.",
          "Rolled out two-step verification (MFA) tenant-wide, alongside the FIDO2/YubiKey policies above, and owned the tenant's security settings baseline.",
        ],
      },
    ],
    links: [],
...
export const timeline = [
  { label: "City University of Seattle", start: 2014.2, end: 2022.45, color: "blue" },
...
export const story = [
  {
    ...
    era: "foundation",
    year: "2014",
    heading: "The foundation: eight years inside the machine",
    text:
      "It starts in Seattle, inside a university's entire technology estate. Eight years as a Technical Product Manager & Senior Systems Engineer, diagramming infrastructure until the inefficiencies had nowhere to hide. That diagramming became a one-year, $2.8M modernization program coordinating three vendors, Sabey, Cisco, and Juniper, alongside five teams and ten network products, with hardware procured straight through the first U.S.–China tariff war's delays and price shocks. Then the cloud: a directed migration to Azure with hybrid connectivity and redundant failover. Annual spend was halved from $250K to $125K, seven racks were consolidated to two, and deployment time was cut by 80% through Terraform and PowerShell automation. Beneath it all ran a tenant-wide security and compliance operation across Microsoft 365: threat protection tuned in Exchange Online Protection and Defender; Purview DLP policies auto-encrypting sensitive outbound mail; Sentinel catching unusual sign-ins and auto-blocking risky accounts; compromised accounts investigated and remediated from the Defender console with forced password resets and revoked sessions; and MFA rolled out to every account. And every year, the Active Directory estate faced a McKinsey security audit measured against ISO 27001, the NIST Cybersecurity Framework, and SOC 2. Every year, it passed.",
  ...
  },
  {
    ...
    era: "fellowship",
    year: "2021",
    heading: "The sharpening: Google Cloud fellowship",
    text:
      "2021 was deliberate sharpening. Selected as one of fifty nationally for Google Cloud's 12-week Cloud Career Jump Start fellowship — hands-on GCP with Google's own engineers, aligned to the Associate Cloud Engineer curriculum. Compute, storage, networking, IAM, and databases, practiced until cloud fluency became cloud instinct — the foundation the BTechs teaching practice stands on today.",
    stat: { n: "1 of 50", l: "selected nationally — Google Cloud fellowship" },
  },
  {
    slug: "uw-pm-fellow",
    era: "fellowship",
    year: "2021",
    heading: "The craft: UW Inclusive Product Management",
    text:
      "And in the same season, product craft. Chosen as one of fifty nationally for the University of Washington's Inclusive Product Management fellowship at the Foster School — a ten-week deep dive into roadmaps, value propositions, and business cases, where selection turned into a coaching seat working with other participants. Infrastructure depth on one hand, product craft on the other — the two tracks this whole story braids together.",
      ...
      sites: [
        {
          ...
          features: [
            ...
            "Birthplace of Bloomberg CORE: the shared parent theme whose mega menus, carousels, and cards became the component library for every future build, cutting new-build engineering cost 50%",
            "Salesforce Marketing Cloud and SalesWings lead scoring by urgency and interest: sales conversions up 17% YoY, email CTR up 25%",
            "Webflow campaign landing pages with twice-weekly social posting, generating leads 2.5x faster year over year",
        ...
        },
        {
          ...
          features: [
            ...
            "SFMC and SalesWings lead scoring and vertical segmentation feeding the Tax pipeline",
