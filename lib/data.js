...
export const story = [
  {
    ...
    text:
      "It starts in Seattle, inside a university's entire technology estate. Nine years as Technical Product Manager & Senior Systems Engineer — diagramming infrastructure until the inefficiencies had nowhere to hide. That diagramming became a one-year, $2.8M modernization program coordinating three vendors — Sabey, Cisco, and Juniper — five teams, and ten network products, with hardware procured straight through the first U.S.–China tariff war's delays and price shocks. Then the cloud: a directed migration to Azure with hybrid connectivity and redundant failover, $125K cut from annual costs — spend halved, seven racks consolidated down to two — and deploy time cut 80% through Terraform and PowerShell automation. And every year, the Active Directory estate faced a McKinsey security audit — measured against ISO 27001, the NIST Cybersecurity Framework, and SOC 2 — and every year, it passed.",
