...
export const roles = [
  ...
  },
  {
    ...
    skills: [
      ...
      "Defender for Office 365", "Microsoft Sentinel", "Purview DLP", "Conditional Access",
...
export const story = [
  {
    ...
    text:
      "It starts in Seattle, inside a university's entire technology estate. Nine years as a Technical Product Manager & Senior Systems Engineer, diagramming infrastructure until the inefficiencies had nowhere to hide. That diagramming became a one-year, $2.8M modernization program coordinating three vendors, Sabey, Cisco, and Juniper, alongside five teams and ten network products, with hardware procured straight through the first U.S.–China tariff war's delays and price shocks. Then the cloud: a directed migration to Azure with hybrid connectivity and redundant failover. Annual spend was halved from $250K to $125K, seven racks were consolidated to two, and deployment time was cut by 80% through Terraform and PowerShell automation. Beneath it all ran a tenant-wide security and compliance operation across Microsoft 365: threat protection tuned in Exchange Online Protection and Defender, Purview DLP policies auto-encrypting sensitive outbound mail, Sentinel catching unusual sign-ins and auto-blocking risky accounts, and MFA rolled out to every account. And every year, the Active Directory estate faced a McKinsey security audit measured against ISO 27001, the NIST Cybersecurity Framework, and SOC 2. Every year, it passed.",
